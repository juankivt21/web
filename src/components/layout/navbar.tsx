    ...
    <>
      <nav
        className={`fixed w-full z-50 transition-all duration-300 ${
          scrolled ? "bg-[#fbf7e8]/95 shadow-md" : "bg-[#fbf7e8]/80"
        } backdrop-blur-sm border-b border-[#d6a104]/20 py-3`}
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center">
              <button
                ...
                className="md:hidden mr-4 text-[#d6a104] hover:text-[#d6a104]/80 transition-colors focus:outline-none p-2"
              ...
              <Link
                href="/"
                className="text-[#d6a104] font-semibold text-xl md:text-2xl relative group ml-2 md:ml-0 py-2"
              >
                <span className="bg-gradient-to-r from-[#d6a104] to-[#d6a104] bg-clip-text text-transparent">
                  360 Vision
                </span>
                <span className="ml-1 font-light">Experience</span>
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#d6a104]/60 transition-all duration-300 group-hover:w-full"></span>
              </Link>
            </div>

            {/* Menú de navegación para pantallas medianas y grandes */}
            <div className="hidden md:flex items-center justify-center space-x-16">
              {menuLinks.slice(1, 5).map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`text-[#d6a104] text-lg hover:text-[#d6a104]/80 transition-all duration-300 transform hover:scale-105 py-3 px-2 ${
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                ...
                target="_blank"
                className="text-[#d6a104] hover:text-[#d6a104]/80 transition-colors p-3 hover:bg-[#d6a104]/10 rounded-full"
              >
              ...
              <Link
                ...
                target="_blank"
                className="text-[#d6a104] hover:text-[#d6a104]/80 transition-colors flex items-center gap-2 p-3 hover:bg-[#d6a104]/10 rounded-full"
              >
                <MessageCircle className="h-6 w-6" />
                <span className="hidden lg:inline font-medium">+34 651 53 39 76</span>
              </Link>
            </div>
          </div>
        </div>
